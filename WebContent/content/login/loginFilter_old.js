/*
 * [old] 로그인 필터링 로직
 * 저장소 : session storage (client side)
 * 
 * */


/* 로그인정보 조회/필터링 function */
// 사용자 입력값과 [client 저장소] session storage에 저장된값을 비교
function loginFilter(loginDto){
	...
	/* filtering */
	// 사용자가 입력한 정보와 session storage에 저장된 정보를 비교하는 로직
